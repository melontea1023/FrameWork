...
bool CreateVertexShader(
	...
	hr = device->CreateInputLayout(
		...
		ppVertexLayout);
	if (FAILED(hr)) {
		MessageBoxA(nullptr, "CreateInputLayout error", "error", MB_OK);
		pBlob->Release();
		return false;
	}
...
bool CreateStructuredBuffer(
	...
	if (FAILED(hr)){
		MessageBoxA(nullptr,"CreateBuffer(StructuredBuffer) error", "Error", MB_OK);
		return false;
	}
...
bool CreateShaderResourceView(
	...
	if (FAILED(hr)){
		MessageBoxA(nullptr, "CreateShaderResourceView error", "Error", MB_OK);
		return false;
	}
...
bool CreateUnOrderAccessView(
	...
	if (FAILED(hr)){
		MessageBoxA(nullptr, "CreateUnorderedAccessView error", "Error", MB_OK);
		return false;
	}
